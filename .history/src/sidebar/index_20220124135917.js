      ...
      <div className="w-2">
        ...
        >
          ...
          {SidebarItems.map((item, index) => {
            return (
              <NavLink to={item.route} className="no-underline p-2">
                <div className="flex w-full ml-3 align-items-center justify-content-start text-white font-bold text-l h-3rem ">
