...
export default function Transfer() {
  ...
  const header = (
    <div className="table-header">
      ...
      <span className="p-input-icon-left">
        ...
        <InputText
          style={{ height: "35px", marginRight: "400px" }}
          type="search"
  ...
  return (
    <div>
      <h2 className="p-mb-3 p-text-light" style={{ marginLeft: "20px" }}>
        Inventory info
      </h2>
        ...
        >
          ...
          <Accordion style={{ paddingBottom: "20px" }}>
            ...
            <AccordionTab header="Description">
              <p>
                recently purchased laptop for Research and Innovation Department
              </p>
            </AccordionTab>
          </Accordion>
