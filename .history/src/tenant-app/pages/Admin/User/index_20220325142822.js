...
class User extends Component {
  ...
  render() {
    ...
    const userColumns = [
      ...
      { field: "role.title", header: "Usertype" },
                  ...
                  <Form id="postform">
                    ...
                    <div className="field col-6">
                      ...
                      <InputText
                        ...
                        className={
                          errors.last_name ? "p-invalid p-d-block" : "p-d-block"
                        }
                      />
                    </div>
                    <div className="field col-6">
                      <label htmlFor="lastname6" className="block font-normal">
                        First name
                      </label>
                      <InputText
                        id="lastname6"
