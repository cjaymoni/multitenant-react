                    ...
                    <div className="formgrid grid">
                      ...
                      <div className="field col-6">
                        ...
                        <InputTextarea
                          ...
                          tooltipOptions={{ position: "bottom" }}
                          tooltip="Manufacturer's Description"
                        />
...
const mapStateToProps = (state) => ({
  manufactures: state.manufactures.manufactures,

  booksize: state.manufactures.booksize,
  pagesize: state.manufactures.pagesize,
});
