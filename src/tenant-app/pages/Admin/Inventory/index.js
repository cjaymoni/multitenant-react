...
class Inventory extends Component {
  ...
  async openInventoryDetails(rowData) {
    ...
    return this.props.history.push("/inventoryinfo");
  }
  ...
  render() {
    ...
    const inventoryColumns = [
      { field: "title", header: "Inventory Name", body: titleBodyTemplate },
      {
        field: "description",
        header: "Description",
