...
class Location extends Component {
  ...
  render() {
    ...
    const locationColumns = [
      { field: 'title', header: 'Location Name', body: titleBodyTemplate },
      {
        field: 'ghana_post',
    ...
    const departmentColumns = [
      { field: 'title', header: 'Department Name', body: depTitleTemplate },
                    ...
                    <div className="formgrid grid">
                      ...
                      <div className="field col-12">
                        ...
                        <InputMask
                          ...
                          onChange={event => handleChange(event, 'ghana_post')}
                        ></InputMask>
                      </div>
                    </div>
                  </Form>
